...
const RecipeCard = ({ menu }) => {
  ...
  return (
    <div
      ...
      className="bg-[#1A1A22] rounded-2xl hover:border hover:border-[#E85C05] hover:cursor-pointer"
    >
      ...
      <div className="space-y-3 p-5">
        ...
        <p className="line-clamp-2 text-sm text-gray-400">{menu.description}</p>
